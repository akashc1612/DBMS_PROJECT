...
<body>
	...
	<span><marquee style="background-image: url('img/bg.png'); color: #ffffff; height:40px;">Convert Light Novel to Anime.</marquee></span><br><br>
	<div class="col-md-8" id="main_content">
		<center><h3>Please Enter the details:</h3></center>
		<form action="addanime1.php" method="post">
